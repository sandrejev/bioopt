...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_mutation', '-m', dest="max_mutation", action='store', help='Maximum mutation number', type=int)
    parser.add_argument('--target_type', '-t', dest="target_type", action='store', help='"Reaction" or "Gene"', type=str)
    parser.add_argument('--generations', '-g', dest="generations", action='store', help='Number of generations', type=int)
    parser.add_argument('--population-size', '-p', dest="population_size", action='store', help='Population size', type=int)
    parser.add_argument('--mutation_rate', '-mRate', dest="mutation_rate", action='store', help='Mutation rate of each element', type=float)
    parser.add_argument('--cx_fraction', '-cxf', dest="cx_fraction", action='store', help='Fraction of children generated by crossover', type=float)
    parser.add_argument('--cxMethod', '-cxm', dest="cxMethod ", action='store', help='"Crossover method ("One", "Two" or "Uni")', type=str)
    parser.add_argument('--flux_calculation', '-fc', dest="flux_calculation", action='store', help='"Flux calculation method ("FBA" or "MOMA")', type=str)
